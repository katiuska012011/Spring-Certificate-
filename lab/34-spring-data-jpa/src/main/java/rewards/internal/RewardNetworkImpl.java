...
public class RewardNetworkImpl implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining) {
		Account account = accountRepository.findAccountByCreditCardNumber(dining.getCreditCardNumber());
		Restaurant restaurant = restaurantRepository.findRestaurantByNumber(dining.getMerchantNumber());
